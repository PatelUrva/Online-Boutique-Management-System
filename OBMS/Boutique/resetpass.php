                ...
                <div class="col-sm-8">
                    <div class="contact-form"  style="margin-left: 300px">
                        ...
                        <form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
                            ...
                            <div class="form-group col-md-10" style="margin-left: 72px">
                                <input type="password" name="oldpass" class="form-control" required="required" placeholder="Old Password">
                            </div>          
                            <div class="form-group col-md-10" style="margin-left: 72px">
...
<?php
    if(isset($_POST['btnReset']))
    {
        ...
        while($row = mysqli_fetch_row($res))
        {
            ...
            {
                echo "<script>window.alert('Old Password entered is wrong!!') </script>";
            }
        }
    }
?>